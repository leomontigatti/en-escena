...
| admin       | Operación del Panel de administración          | Eventos, Bases del evento, usuarios internos, correcciones administrativas, publicaciones y acciones permitidas sobre datos operativos | Credenciales técnicas fuera de los flujos definidos                                                               |
