...
- Payment instructions (the event's bank identifiers and how-to-pay text, read by the portal payments page): `app/lib/finances/bank-identifiers.ts`, and the six `paymentInstructions*` fields of `app/lib/admin/events/form-values.ts`
