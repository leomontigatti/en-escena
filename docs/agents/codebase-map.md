...
- Modules: `app/lib/presentations/ordering.ts` (the pure block order, the dancer gap and moving a row by hand), `app/lib/presentations/warnings.ts` (the pure `Advertencia` derivation), `app/lib/presentations/evaluation-lock.server.ts` (the seam the choreography lock reads), `app/lib/presentations/participation.server.ts` (the event's participation read and the automatic ordering), `app/features/admin/presentations/list/server.ts`, `app/features/admin/presentations/list/view.tsx`
...
- Tests: `app/lib/presentations/presentation-table.db.test.ts`, `app/lib/presentations/ordering.test.ts`, `app/lib/presentations/warnings.test.ts`, `app/lib/presentations/participation.server.db.test.ts`, `app/features/admin/presentations/list/view.test.tsx`
