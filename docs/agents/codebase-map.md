...
- Judging persistence: `app/lib/judging/judge-list.server.ts`, `app/lib/judging/save-score.server.ts`, `app/lib/judging/disqualification.server.ts`, `app/lib/judging/score-settlement.server.ts` (administration's edit, annul and settle), `app/lib/judging/presentation-scores.server.ts`, `app/lib/judging/criteria.server.ts`, `app/lib/judging/evaluation-status.server.ts`, `app/lib/judging/judge-write.server.ts`
