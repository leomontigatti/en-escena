...
Read the repo's domain/architecture docs and ADRs before proposing: `CONTEXT.md`,
`docs/adr/`, and [`docs/agents/domain.md`](../domain.md). Treat recorded decisions (the ADRs)
as **binding** — do not propose anything that contradicts one.
