...
[`docs/agents/domain.md`](../domain.md)) before resolving anything substantive.
...
most mistakes). If something's broken and you can't fix it, finish the merge anyway and flag
