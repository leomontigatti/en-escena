...
ALTER TABLE "en_escena_score" ADD CONSTRAINT "score_judge_assignment_fk" FOREIGN KEY ("judge_assignment_id") REFERENCES "public"."en_escena_judge_assignment"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "en_escena_submodality_criterion" ADD CONSTRAINT "submodality_criterion_event_fk" FOREIGN KEY ("event_id") REFERENCES "public"."en_escena_event"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "en_escena_submodality_criterion" ADD CONSTRAINT "submodality_criterion_submodality_fk" FOREIGN KEY ("submodality_id") REFERENCES "public"."en_escena_submodality"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
