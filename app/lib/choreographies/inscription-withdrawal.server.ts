...
/**
 * Evidencia de una inscripción: plata asignada o una línea de comprobante. Es la
 * justificación para conservar la fila, así que también es lo que la baja del
 * roster consulta para elegir entre borrar y retirar, y lo que el loader del
 * detalle admin usa para contarle la consecuencia al admin antes de confirmar.
 */
 ...
 * `withdrawnAt` y se queda con la plata encima.
 *
 ...
 * insertar otra: el `id` de la inscripción sobrevive, y con él la plata y la
