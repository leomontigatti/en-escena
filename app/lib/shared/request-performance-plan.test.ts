...
const permanentRuleDocuments = [
  ...
  },
  {
    ...
    requiredText: [
      ...
      "Use a pending state on the button",
      "inline spinner",
      "Keep the current rows or results visible",
      "Use skeletons only",
      "Do not use skeletons",
      "View Transitions",
      "RHF forms must not end in `form.submit()`",
      "React Router with `useSubmit`, `useFetcher.submit`",
      "must build and send `FormData`",
    ],
  },
  {
