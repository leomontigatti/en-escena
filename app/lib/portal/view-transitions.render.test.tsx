...
describe("portal view transitions", () => {
  ...
  test("scopes list-detail transitions to bailarines and profesores record names", async () => {
    ...
    await renderRoute(
      ...
      <PortalProfesorRouteView loaderData={buildProfessorDetailLoaderData()} />,
    );
...
function buildDancerDetailLoaderData() {
  ...
  } as Parameters<typeof PortalBailarinDetalleRouteView>[0]["loaderData"];
}
...
function buildProfessorDetailLoaderData() {
  ...
  } as Parameters<typeof PortalProfesorRouteView>[0]["loaderData"];
}
