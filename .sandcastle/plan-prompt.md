...
!`gh issue list --state open --label ready-for-agent --limit 100 --json number,title,body,labels,comments --jq '[.[] | {number, title, body: ((.body // "")[0:2000]), labels: [.labels[].name], comments: [(.comments[-2:][]?.body // "")[0:1200]]}]'`
