...
STORAGE_BACKUP_BUCKETS="${STORAGE_BACKUP_BUCKETS:-en-escena-dancer-documents,en-escena-choreography-music,en-escena-event-documents,enescena-seminar-pictures}"
